  ...
  public: {
    Tables: {
      ...
      configuration_options: {
        ...
        Relationships: [
          {
            foreignKeyName: "configuration_options_group_id_fkey"
            columns: ["group_id"]
            isOneToOne: false
      ...
      fabric_assets: {
        ...
        Relationships: [
          {
            foreignKeyName: "fabric_assets_fabric_id_fkey"
            columns: ["fabric_id"]
            isOneToOne: false
            referencedRelation: "fabrics"
            referencedColumns: ["id"]
      ...
      fabric_imports: {
        ...
        Relationships: [
          {
            foreignKeyName: "fabric_imports_created_by_fkey"
            columns: ["created_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      fabrics: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "fabrics_updated_by_fkey"
            columns: ["updated_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
    ...
    Enums: {
      app_role: "admin" | "tailor" | "employee"
      fabric_asset_type: "photo" | "texture"
